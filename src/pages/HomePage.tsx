...
export async function HomePage({ cartCount }: { cartCount: number }) {
    ...
    return (
        ...
        >
            <div
                id="catalogue-cart-region"
                data-loading-region
                data-pending-navigation="#cart-link"
                aria-busy="false"
            >
                <p
                            ...
                            <article class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
                                ...
                                <div class="grid gap-3 p-4">
                                    ...
                                    <form
                                        ...
                                        hx-swap="innerHTML"
                                        hx-sync="#catalogue-cart-region:queue all"
                                        hx-disable="global #catalogue-cart-region :is(button,input)"
